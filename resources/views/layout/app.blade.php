    ...
    ***********************************-->
    <div id="main-wrapper">
            ...
            <div class="header-content">
                        ...
                        <ul class="navbar-nav header-right main-notification">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                   <img src="{{ asset('images/profile/kosong.png') }} " width="20" alt="">
				...
				<div class="sub-header">
					...
					<div class="d-flex align-items-center">
						<a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1">Hari</a>
						<a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1">Bulan</a>
						<a href="javascript:void(0);" class="btn btn-xs btn-primary light">Tahun</a>
					</div>
				</div>
			</div>
        </div>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="/dashboard/kelas">Kelas</a></li>
							<li><a href="/dashboard/guru">Guru</a></li>
							<li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Murid<span class="badge badge-xs badge-danger"></span></a>
                                <ul aria-expanded="false">
                                    <li><a href="/dashboard/murid">Semua</a></li>
									<li><a href="/dashboard/muridX">X</a></li>
                                    <li><a href="/dashboard/muridXI">XI</a></li>
									<li><a href="/dashboard/muridXII">XII</a></li>
                                </ul>
                            </li>
							<li><a href="/dashboard/data-pelanggaran">Data Pelanggaran</a></li>
                        </ul>
                    </li>
					
					<li><a href="/dashboard/violation" class="ai-icon" aria-expanded="false">
                    ...
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/dashboard/violation">Semua</a></li> --}}
                            {{-- <li><a href="chart-morris.html">X</a></li>
                            <li><a href="chart-chartjs.html">XI</a></li>
                            <li><a href="chart-chartist.html">XII</a></li> --}}
                        {{-- </ul>
                    </li> --}}
                </ul>
			</div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed; Developed by <a href="" target="">Hana</a> SMK TB</p>
            </div>
        </div>
        <!--**********************************
            Footer end
