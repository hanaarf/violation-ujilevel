    ...
    <div class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center">
        ...
        <div class="weather-btn mb-2">
            ...
            <select class="form-control style-1 default-select  mr-3 ">
                <option>Depok, IDN</option>
                <option>Jakarta, IDN</option>
                <option>Bandung, IDN</option>
            </select>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 m-t35">
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <h2 class="text-black mb-2 font-w600">{{ $guru }}</h2>
                    <p class="mb-0 fs-14">
                        ...
                        <span class="text-success mr-1">total</span>guru
                    </p>	
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 m-t35">
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <h2 class="text-black mb-2 font-w600">{{ $murid }}</h2>
                    <p class="mb-0 fs-13">
                        <svg width="29" height="22" viewbox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="text-success mr-1">total</span>murid
                    </p>	
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 m-t35">
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <h2 class="text-black mb-2 font-w600">{{ $kelas }}</h2>
                    <p class="mb-0 fs-14">
                        <svg width="29" height="22" viewbox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="text-danger mr-1">total</span>kelas
                    </p>	
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 m-t35">
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <h2 class="text-black mb-2 font-w600">{{ $pelanggaran }}</h2>
                    <p class="mb-0 fs-14">
                        <svg width="29" height="22" viewbox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="text-success mr-1">total</span>pelanggaran
                    </p>	
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-9 col-xxl-8">
            <div class="card">
                <div class="card-header border-0 flex-wrap pb-0">
                    <div class="mb-3">
                        <h4 class="fs-20 text-black">Grafik Pelanggaran</h4>
                        <p class="mb-0 fs-12 text-black">SMK Taruna Bhakti</p>
                    </div>
        ...
        <div class="col-xl-3 col-xxl-4">
            <div class="card">
                <div class="card-header border-0 pb-0">
                    <h4 class="fs-20 text-black">Pelanggar</h4>
                </div>
                    ...
                    <div class="chart-content">	
                        <div class="d-flex justify-content-between mb-2 align-items-center">
                            <div>
                                ...
                                <span class="fs-14">Kelas X (66%)</span>
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-between mb-2 align-items-center">
                            <div>
                                ...
                                <span class="fs-14">Kelas XI (50%)</span>
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-between mb-2 align-items-center">
                            <div>
                                ...
                                <span class="fs-14">Kelas XII (11%)</span>
                            </div>
                            <div>
