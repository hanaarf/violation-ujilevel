                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/dashboard/murid-deleted"><button type="button" class="btn btn-rounded btn-outline-danger">Data terhapus</button></a> <br><br>
                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            ...
                                            {{-- <td><a href="javascript:void(0);"><strong>guru dgn id {{ $item->kelas->guru_id }}</strong></a></td> --}}
