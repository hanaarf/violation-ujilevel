            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form custom_file_input">
                        <form  method="POST" action="/dashboard/form-murid">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="tgl_lahir" type="date" class="form-control" placeholder="tgl lahir">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="point" type="text" class="form-control" placeholder="point" value="0">
                                </div>
                            </div>
