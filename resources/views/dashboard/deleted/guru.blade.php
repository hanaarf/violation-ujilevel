    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Guru Terhapus</h4>
            </div>

            <div class="card-body">
                <a href="/dashboard/guru">
                    <button type="button" class="btn btn-rounded btn-outline-primary">Back</button></a>
              <br><br>
                    ...
                    <table id="example3" class="display" style="min-width: 845px">
                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td>{{ $item->email }}</td>
                                <td>
                                    <a href="/dashboard/{{ $item->id }}/restoreguru"><button type="button" class="mb-2 badge badge-success">   restore data </button></a>

                                    <form action="/dashboard/forcedeleteguru/{{ $item->id }}" method="POST" onsubmit="return confirm('yakin hapus?')">
                                        @csrf
                                        @method('DELETE')
