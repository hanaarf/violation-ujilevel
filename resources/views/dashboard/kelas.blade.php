...
<div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="/dashboard/form-kelas">
                            <button type="button" class="btn btn-rounded btn-outline-primary">+ Add</button></a><br><br>
                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span>
                                                    <a href="/dashboard/{{ $item->id }}/editkelas" ><button type="button" class="ml-3 mb-1 btn btn-warning shadow btn-xs sharp mr-1">   <i class="mdi mdi-border-color"></i> </button></a>
                                                    
                                                    <form action="/dashboard/hapuskelas/{{ $item->id }}" method="POST" onsubmit="return confirm('yakin hapus?')">
                                                     @csrf
                                                     @method('DELETE')
